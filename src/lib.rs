...
#[derive(Debug)]
pub struct CircleCDProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CircleCDProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CircleCD processing");
    
    let mut processor = CircleCDProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CircleCDProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CircleCDProcessor::new(false);
